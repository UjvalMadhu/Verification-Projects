...
source "dc/verilog_name_rules.tcl"
#
...
remove_design -all
file mkdir "./netlist" "./sdf" "./spf" "./report" "./report/dc" "./report/pt" "./report/pr" "./saif"
...
foreach_in_collection scan_input $scan_inputs {
  ...
  set_dft_signal -view existing_dft -port $t_scan_in -type ScanDataIn -connect_to $t_scan_in
...
foreach_in_collection scan_output $scan_outputs {
  ...
  set_dft_signal -view existing_dft -port $t_scan_out -type ScanDataOut -connect_to $t_scan_out
...
#
#compile -map_effort $my_compile_effort -incremental_mapping -scan
#
compile_ultra -retime -no_autoungroup -incremental -scan
